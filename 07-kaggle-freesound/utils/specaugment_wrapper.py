...
class MaybeSpecAugment(Layer):
    ...
    def __init__(
        ...
        """
        super(MaybeSpecAugment, self).__init__(name="MaybeSpecAugment")
    ...
    def call(self, inputs: tf.Tensor, training=None, **kwargs):
        ...
        if training:
            ...
            rnd = tf.random.uniform(shape=(), minval=0, maxval=1)
            return transform(rnd)
        return inputs
